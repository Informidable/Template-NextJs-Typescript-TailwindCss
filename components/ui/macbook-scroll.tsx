...
const getCurrentDate = () => {
  const now = new Date();
  return now.toLocaleDateString('fr-FR'); // Utilise le format français pour la date
};
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-40 lg:py-64 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 overflow-hidden"
    >
      <motion.h2
        style={{
        ...
        {title || (
          <div className="space-y-3">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">
              Bienvenue chez{' '}
              <span className="text-primary font-extrabold">Informidable</span>
            </h1>
          </div>
        )}
      </motion.h2>
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        >
          <Image
            src="/img/logo/informidable1.png"
            alt="informidable logo"
            width={150}
            height={150}
          />
        </div>
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-black rounded-2xl p-2"
      >
        ...
        <Image
          ...
          height={1000}
        />
        <footer className="bg-[#1E2225] w-full h-10 z-10">
          <div className="flex justify-between items-center px-1">
            <div className="flex pt-2">
              <div className="flex justify-between items-center gap-2 ">
                <div>
                  <Image
                    alt=""
                    src="/img/windows/icon-windows.png"
                    width={25}
                    height={25}
                    className=""
                  />
                ...
                <div>
                  <Image
                    alt=""
                    src="/img/windows/icon-search.png"
                    width={25}
                    height={25}
                    className=""
                  />
                ...
                <div>
                  <Image
                    alt=""
                    src="/img/windows/icon-screens.png"
                    width={25}
                    height={25}
                    className=""
                  />
                ...
                <div>
                  <Image
                    alt=""
                    src="/img/windows/icon-internet-search.png"
                    width={25}
                    height={25}
                    className=""
                  />
                ...
                <div>
                  <Image
                    alt=""
                    src="/img/windows/icon-ms-teams.png"
                    width={25}
                    height={25}
                    className=""
                  />
                ...
                <div>
                  <Image
                    alt=""
                    src="/img/windows/icon-folder.png"
                    width={25}
                    height={25}
                    className=""
                  />
            ...
            <div className="flex items-center gap-2 pt-1">
              <svg
                ...
                className="h-4 w-4 opacity-80 text-white"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 text-blue-mic"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="currentColor"
                fill="none"
              ...
              <div className=" opacity-80 text-white text-xs">ENG</div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 opacity-80 text-white"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="currentColor"
                fill="none"
              ...
              <div className="flex flex-col items-center">
                <div className="text-white text-[8px]">{currentTime}</div>
                <div className="text-white text-[8px]">{currentDate}</div>
              </div>
            </div>
          </div>
        </footer>
